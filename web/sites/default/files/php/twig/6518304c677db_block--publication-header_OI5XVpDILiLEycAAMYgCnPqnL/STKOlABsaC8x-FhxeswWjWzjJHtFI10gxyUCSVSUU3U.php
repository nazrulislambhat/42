...
/* themes/fortytwo/components/templates/block/block--publication-header.html.twig */
class __TwigTemplate_c342045cc8c5c337055feaec94808aed extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        // line 38
        echo "    <div";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content_attributes"] ?? null), "addClass", [0 => "page-header"], "method", false, false, true, 38), 38, $this->source), "html", null, true);
        echo ">
      ";
        // line 39
  ...
  ";
    ...
    {
        return "themes/fortytwo/components/templates/block/block--publication-header.html.twig";
    }
...
<div{{ attributes }}>
  ...
  {{ title_suffix }}
  {% block content %}
    <div{{ content_attributes.addClass('page-header') }}>
      {{ content }}
    </div>
  {% endblock %}
</div>
", "themes/fortytwo/components/templates/block/block--publication-header.html.twig", "/var/www/html/web/themes/fortytwo/components/templates/block/block--publication-header.html.twig");
    }
